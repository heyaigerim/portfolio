...
for (let i = 0; i < testimonialsItem.length; i++) {
  ...
  modalText.innerHTML = this.querySelector("[data-testimonials-text]").innerHTML; // ✅ THIS LINE FIXES IT
...
projectItems.forEach(item => {
  item.addEventListener("click", function (e) {
    e.preventDefault();
    projectModalTitle.textContent = item.dataset.projectTitle;
    projectModalText.textContent = item.dataset.projectDesc;
    projectModalLink.href = item.dataset.projectLink;
    toggleProjectModal();
  });
});
